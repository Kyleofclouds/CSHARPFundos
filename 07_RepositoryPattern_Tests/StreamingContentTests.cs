...
namespace _07_RepositoryPattern_Tests
{
    ...
    public class StreamingContentTests
    {
        ...
        public void StreamingContentNotes()
        {
            ...
            Movie newMovie = new Movie("Venom", "The best romance movie our age", 9005, MaturityRating.PG, true, GenreType.RomCom, 105.0);
        }
        [DataTestMethod]
        ...
        {
            StreamingContent content = new StreamingContent("Generic Title","Description Here",5, rating, true,GenreType.Documentary);
